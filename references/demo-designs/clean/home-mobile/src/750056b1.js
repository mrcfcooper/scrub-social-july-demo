...
function TabBar({ active, onChange }) {
  ...
  return (
    <div style={{
      // sticky: pinned to the frame bottom, floats above the scrolling screen.
      // bottom respects the device safe-area (iOS home indicator / Android nav bar)
      // in production; falls back to 18px in the browser mock.
